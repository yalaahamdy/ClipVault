<div align="center">
  ...
  **The Ultra-Fast, Private & Beautiful Local-First Clipboard Manager & Password Vault with OneOCR Engine**
  ...
  [![Release](https://img.shields.io/badge/Release-v1.3.0-38bdf8?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/yalaahamdy/ClipVault/releases)
...
2. **محرك OneOCR Professional المدمج محلياً**: يستخرج النصوص العربية والإنجليزية من الصور ولقطات الشاشة في أجزاء من الثانية.
3. **خزينة كلمات مرور مشفرة بتشفير عسكري AES-256-GCM**: تحمي بيانات تسجيل الدخول وبطاقات الدفع والملاحظات السرية محلياً 100%.
...
| :--- | :--- | :--- | :--- |
| **`ClipVault_1.3.0_x64-setup.exe`** | مثبت كامل (Full Installer) | الإصدار 1.3.0 متضمناً محرك OneOCR وخزينة كلمات المرور | [**تحميل مباشر**](https://github.com/yalaahamdy/ClipVault/releases/download/v1.3.0/ClipVault_1.3.0_x64-setup.exe) |
...
`src-tauri/target/release/bundle/nsis/ClipVault_1.3.0_x64-setup.exe`
